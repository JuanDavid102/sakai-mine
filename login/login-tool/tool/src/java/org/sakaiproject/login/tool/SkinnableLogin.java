...
public class SkinnableLogin extends HttpServlet implements Login {
	...
	public LoginRenderContext startPageContext(String skin, HttpServletRequest request, HttpServletResponse response)
	{
		...
		String loginHomeUrl = serverConfigurationService.getString("unir.home.url", null);
		String loginVirtualResourcesUrl = serverConfigurationService.getString("virtual.resources.url", null);
		String loginPaymentPortalUrl = serverConfigurationService.getString("contact.url", null);
		String loginContactUrl = serverConfigurationService.getString("payment.portal.url", null);
