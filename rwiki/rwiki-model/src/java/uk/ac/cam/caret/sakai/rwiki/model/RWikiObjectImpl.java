...
public abstract class RWikiObjectImpl implements RWikiObject
{
	 ...
	 * @param pageGroups
	 */
	public void setPageGroupsAsList(List pageGroups) {
		if (pageGroups != null) {
			this.pageGroups = new HashSet<>(pageGroups);
		} else {
			this.pageGroups = new HashSet<>();
		}
	}
	 ...
	 */
	public List getPageGroupsAsList() {
		if (pageGroups != null) {
			return new ArrayList<>(pageGroups);
		}
		return null;
	}
