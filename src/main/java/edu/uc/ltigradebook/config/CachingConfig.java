...
public class CachingConfig {
    ...
    //Evict the grades cache every 10 minutes.
    ...
    public void gradeCacheEvict() {
        log.info("Evicting submissions and assignments caches of the Gradebook application, the cache is refreshed every 10 minutes.");
    }
