...
<h:panelGroup rendered="#{totalScores.isOneSelectionType}">
  <fieldset class="short-summary-box">
    ...
    <ul>
      <li><h5 style="display: inline;"><h:outputText value="#{evaluationMessages.correct_title}" />: <h:outputText value="#{totalScores.results[studentScores.getLongAssessmentGradingId()][0]}" /></h5></li>
      <li><h5 style="display: inline;"><h:outputText value="#{evaluationMessages.incorrect_title}" />: <h:outputText value="#{totalScores.results[studentScores.getLongAssessmentGradingId()][1]}" /></h5></li>
      <li><h5 style="display: inline;"><h:outputText value="#{evaluationMessages.empty_title}" />: <h:outputText value="#{totalScores.results[studentScores.getLongAssessmentGradingId()][2]}" /></h5></li>
    <ul>
  </fieldset>
</h:panelGroup>
