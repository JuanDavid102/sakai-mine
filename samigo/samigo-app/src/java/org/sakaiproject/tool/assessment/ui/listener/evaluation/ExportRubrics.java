  ...
  implements ActionListener
{
  ...
  public void processAction(ActionEvent ae) throws AbortProcessingException {
    ...
    try {
      ...
      String templateFilename = rb.getFormattedMessage("template_rubric_combination", rb.getString("question"), bean.getItemName());
      ...
      for(AgentResults ar : agents) {
        ...
        final ZipEntry zipEntryPdf = new ZipEntry(rb.getFormattedMessage("template_rubric_combination", user.getEid(), templateFilename) + ".pdf");
      ...
      String fileName = rb.getFormattedMessage("template_rubric_combination", tBean.getAssessmentName().replaceAll(" ", "_"), templateFilename);
      response.setHeader("Content-Disposition", "attachment; filename=\"" + rb.getFormattedMessage("template_rubric_combination", fileName, rb.getString("rubrics")) + ".zip\"");
